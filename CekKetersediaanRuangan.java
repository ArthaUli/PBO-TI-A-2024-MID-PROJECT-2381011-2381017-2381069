...
public class CekKetersediaanRuangan {
    ...
    static int totalRuangan = 10;  // Jumlah total ruangan yang tersedia
    static int ruanganTerpakai = 0;  // Jumlah ruangan yang sudah terisi
