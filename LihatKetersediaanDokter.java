...
public class LihatKetersediaanDokter {
    static class Pasien {
        String nama;
        int umur;
        String alamat;
    ...
    static String[] daftarDokter = {
            "Dr. Siburian (Poli Gigi)", "Dr. Gabriela (Poli Gigi)", "Dr. Oji (Radiologi)",
            "Dr. Yohanes (Poli Mata)", "Dr. Tirta (Jantung)", "Dr. Delon (THT)",
